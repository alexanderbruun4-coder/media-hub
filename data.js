...
const MEDIA_DATA = {
  ...
  games: {
    label: "Games",
    metaLabel: "Platform",
    categories: ["FPS", "RPG", "Simulator", "Sports", "Strategy", "Horror"],
    items: [
      {
        ...
        category: "FPS",
        description:
          "A tactical shooter where every bullet matters. Command a squad of mech-suited operatives through destructible urban battlefields in a gripping 20-hour campaign.",
        image: "https://placehold.co/400x600/450a0a/fca5a5?text=Ironclad+Protocol",
        featured: true,
      },
      {
        title: "Emberfall",
        ...
        category: "RPG",
        description:
          "An open-world fantasy epic where your choices reshape the kingdom's fate. 100+ hours of quests, deep character builds, and a branching story with 12 endings.",
        image: "https://placehold.co/400x600/7c2d12/fed7aa?text=Emberfall",
      },
      {
        title: "Haulage Empire",
        meta: "PC",
        rating: 8.2,
        category: "Simulator",
        description:
          "Build a logistics company from a single rusty truck to a continental freight empire. Obsessively detailed driving physics and a surprisingly relaxing gameplay loop.",
        image: "https://placehold.co/400x600/1e3a5f/bfdbfe?text=Haulage+Empire",
      },
      {
        title: "Top Corner 26",
        meta: "PS5 / Xbox / Switch",
        rating: 7.8,
        category: "Sports",
        description:
          "The definitive football sim returns with revamped career mode, cross-platform leagues, and stadium atmospheres that finally feel alive.",
        image: "https://placehold.co/400x600/052e16/86efac?text=Top+Corner+26",
      },
      {
        title: "Dominion of Ash",
        meta: "PC",
        rating: 8.8,
        category: "Strategy",
        description:
          "A grand strategy game set in a world recovering from a magical apocalypse. Rebuild civilization, forge alliances, and decide whether magic should return at all.",
        image: "https://placehold.co/400x600/3b0764/d8b4fe?text=Dominion+of+Ash",
      },
      {
        ...
        category: "Horror",
        description:
          "A deep-sea survival horror set in a collapsing research station 4,000 meters down. No weapons, limited oxygen, and something in the dark that learns from you.",
        image: "https://placehold.co/400x600/0c0a09/7dd3fc?text=Depth+Pressure",
      },
      {
        title: "Vector Strike",
        meta: "PC / Xbox",
        ...
        category: "FPS",
        description:
          "A movement-focused arena shooter with grappling hooks, wall-running, and a thriving competitive scene. Easy to learn, brutal to master.",
        image: "https://placehold.co/400x600/171717/f97316?text=Vector+Strike",
      },
      {
        title: "Starling Farm",
        meta: "PC / Switch",
        ...
        category: "Simulator",
        description:
          "Inherit your grandmother's orbital greenhouse and grow impossible crops in zero gravity. A cozy space-farming sim with charming characters and secrets in every asteroid.",
        image: "https://placehold.co/400x600/365314/d9f99d?text=Starling+Farm",
      },
      {
        title: "Runes of the Deep",
        meta: "PC / PS5 / Xbox",
        rating: 8.3,
        category: "RPG",
        description:
          "A dungeon-crawling action RPG where the dungeon rebuilds itself around your playstyle. Co-op for up to four players.",
        image: "https://placehold.co/400x600/312e81/a5b4fc?text=Runes+of+the+Deep",
      },
      {
        title: "Checkmate City",
        meta: "PC / Mobile",
        rating: 7.6,
        category: "Strategy",
        description:
          "A puzzle-strategy hybrid where you manage a city whose districts move like chess pieces. Every turn reshapes the board — and your citizens' lives.",
        image: "https://placehold.co/400x600/44403c/e7e5e4?text=Checkmate+City",
      },
    ],
  },
